...
fn do_memberof(
    ...
    tgte.add_ava_if_not_exist("class", ValueClass::MemberOf.into());
...
fn apply_memberof(
    ...
    while !group_affect.is_empty() {
        ...
        for (pre, mut tgte) in work_set.into_iter() {
            ...
            if !tgte.attribute_equality("class", &ValueClass::Group.into()) {
    ...
    other_cache
        ...
        .try_for_each(|(auuid, (pre, mut tgte))| {
            ...
            debug_assert!(!tgte.attribute_equality("class", &ValueClass::Group.into()));
...
impl Plugin for MemberOf {
    ...
    fn post_delete(
        ...
        let group_affect = cand
            ...
            .filter_map(|e| {
                // Is it a group?
                if e.attribute_equality("class", &ValueClass::Group.into()) {
            ...
            .chain(
                ...
                cand.iter()
                    .filter_map(|post| {
                        if post.attribute_equality("class", &ValueClass::DynGroup.into()) {
        ...
        let group_affect = cand
            ...
            .chain(
                pre_cand
                    .iter()
                    .filter_map(|pre| {
                        if pre.attribute_equality("class", &ValueClass::Group.into()) {
            ...
            .chain(
                cand.iter()
                    .filter_map(|post| {
                        if post.attribute_equality("class", &ValueClass::Group.into()) {

...
pub static SCHEMA_ATTR_DISPLAYNAME_DL7: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_MAIL_DL7: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_SSH_PUBLICKEY: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_PRIMARY_CREDENTIAL: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_LEGALNAME_DL7: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_NAME_HISTORY: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_RADIUS_SECRET: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_DOMAIN_NAME: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_LDAP_ALLOW_UNIX_PW_BIND: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_DOMAIN_LDAP_BASEDN: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_LDAP_MAXIMUM_QUERYABLE_ATTRIBUTES: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_DOMAIN_DISPLAY_NAME: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_DOMAIN_UUID: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_DOMAIN_SSID: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_DENIED_NAME_DL10: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_DOMAIN_TOKEN_KEY: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_FERNET_PRIVATE_KEY_STR: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_GIDNUMBER: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_BADLIST_PASSWORD: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_AUTH_SESSION_EXPIRY: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_AUTH_PRIVILEGE_EXPIRY: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_AUTH_PASSWORD_MINIMUM_LENGTH: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_LOGINSHELL: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_UNIX_PASSWORD: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_NSUNIQUEID: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_ACCOUNT_EXPIRE: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_ACCOUNT_VALID_FROM: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_ACCOUNT_SOFTLOCK_EXPIRE: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_WEBAUTHN_ATTESTATION_CA_LIST: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_OAUTH2_RS_NAME: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_OAUTH2_RS_ORIGIN_DL7: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_OAUTH2_RS_ORIGIN_LANDING: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_OAUTH2_ALLOW_LOCALHOST_REDIRECT_DL4: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_OAUTH2_RS_CLAIM_MAP_DL4: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_OAUTH2_RS_SCOPE_MAP: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_OAUTH2_RS_SUP_SCOPE_MAP: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_OAUTH2_RS_BASIC_SECRET: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_OAUTH2_RS_TOKEN_KEY: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_OAUTH2_RS_IMPLICIT_SCOPES: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_OAUTH2_CONSENT_SCOPE_MAP: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_OAUTH2_STRICT_REDIRECT_URI_DL7: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_ES256_PRIVATE_KEY_DER: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_RS256_PRIVATE_KEY_DER: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_JWS_ES256_PRIVATE_KEY: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_PRIVATE_COOKIE_KEY: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_OAUTH2_ALLOW_INSECURE_CLIENT_DISABLE_PKCE: SchemaAttribute =
    SchemaAttribute {
...
pub static SCHEMA_ATTR_OAUTH2_JWT_LEGACY_CRYPTO_ENABLE: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_CREDENTIAL_UPDATE_INTENT_TOKEN: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_PASSKEYS: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_ATTESTED_PASSKEYS: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_DYNGROUP_FILTER: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_OAUTH2_PREFER_SHORT_USERNAME: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_API_TOKEN_SESSION: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_USER_AUTH_TOKEN_SESSION: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_OAUTH2_SESSION: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_SYNC_TOKEN_SESSION: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_SYNC_COOKIE: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_GRANT_UI_HINT: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_SYNC_CREDENTIAL_PORTAL: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_SYNC_YIELD_AUTHORITY: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_CREDENTIAL_TYPE_MINIMUM: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_LIMIT_SEARCH_MAX_RESULTS_DL6: SchemaAttribute = SchemaAttribute {
    uuid: UUID_SCHEMA_ATTR_LIMIT_SEARCH_MAX_RESULTS,
    name: Attribute::LimitSearchMaxResults,
    description: "The maximum number of query results that may be returned in a single operation"
        .to_string(),
    multivalue: false,
    syntax: SyntaxType::Uint32,
    ..Default::default()
...
pub static SCHEMA_ATTR_LIMIT_SEARCH_MAX_FILTER_TEST_DL6: SchemaAttribute = SchemaAttribute {
    uuid: UUID_SCHEMA_ATTR_LIMIT_SEARCH_MAX_FILTER_TEST,
    name: Attribute::LimitSearchMaxFilterTest,
    description: "The maximum number of entries that may be examined in a partially indexed query"
        .to_string(),
    multivalue: false,
    syntax: SyntaxType::Uint32,
    ..Default::default()
...
pub static SCHEMA_ATTR_KEY_INTERNAL_DATA_DL6: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_KEY_PROVIDER_DL6: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_KEY_ACTION_ROTATE_DL6: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_KEY_ACTION_REVOKE_DL6: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_KEY_ACTION_IMPORT_JWS_ES256_DL6: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_KEY_ACTION_IMPORT_JWS_RS256_DL6: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_PATCH_LEVEL_DL7: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_DOMAIN_DEVELOPMENT_TAINT_DL7: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_DOMAIN_ALLOW_EASTER_EGGS_DL9: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_IMAGE: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_OAUTH2_DEVICE_FLOW_ENABLE: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_LINKED_GROUP_DL8: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_ALLOW_PRIMARY_CRED_FALLBACK_DL8: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_CERTIFICATE_DL7: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_APPLICATION_PASSWORD_DL8: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_APPLICATION_URL: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_MESSAGE_TEMPLATE: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_SEND_AFTER: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_DELETE_AFTER: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_SENT_AT: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_MAIL_DESTINATION: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_OAUTH2_ACCOUNT_PROVIDER: SchemaAttribute = SchemaAttribute {
    uuid: UUID_SCHEMA_ATTR_OAUTH2_ACCOUNT_PROVIDER,
    name: Attribute::OAuth2AccountProvider,
    description: "The reference to the OAuth2 client that provides authentication for this entry."
        .to_string(),
    sync_allowed: true,
    syntax: SyntaxType::ReferenceUuid,
    ..Default::default()
...
pub static SCHEMA_ATTR_OAUTH2_ACCOUNT_CREDENTIAL_UUID: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_OAUTH2_ACCOUNT_UNIQUE_USER_ID: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_OAUTH2_CLIENT_ID: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_OAUTH2_CLIENT_SECRET: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_OAUTH2_AUTHORISATION_ENDPOINT: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_OAUTH2_TOKEN_ENDPOINT: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_OAUTH2_REQUEST_SCOPES: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_HMAC_NAME_HISTORY: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_IN_MEMORIAM: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_ENABLED: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_OAUTH2_CONSENT_PROMPT_ENABLE: SchemaAttribute = SchemaAttribute {
...
pub static SCHEMA_ATTR_S256: SchemaAttribute = SchemaAttribute {
...
// === classes ===
pub static SCHEMA_CLASS_PERSON_DL8: SchemaClass = SchemaClass {
...
pub static SCHEMA_CLASS_OAUTH2_ACCOUNT: SchemaClass = SchemaClass {
...
pub static SCHEMA_CLASS_ORGPERSON: SchemaClass = SchemaClass {
...
pub static SCHEMA_CLASS_GROUP_DL6: SchemaClass = SchemaClass {
...
pub static SCHEMA_CLASS_DYNGROUP: SchemaClass = SchemaClass {
...
pub static SCHEMA_CLASS_ACCOUNT_POLICY_DL8: SchemaClass = SchemaClass {
...
pub static SCHEMA_CLASS_ACCOUNT_DL5: SchemaClass = SchemaClass {
...
pub static SCHEMA_CLASS_SERVICE_ACCOUNT_DL7: SchemaClass = SchemaClass {
...
pub static SCHEMA_CLASS_SYNC_ACCOUNT_DL7: SchemaClass = SchemaClass {
...
pub static SCHEMA_CLASS_DOMAIN_INFO_DL10: SchemaClass = SchemaClass {
...
pub static SCHEMA_CLASS_POSIXGROUP: SchemaClass = SchemaClass {
...
pub static SCHEMA_CLASS_POSIXACCOUNT: SchemaClass = SchemaClass {
...
pub static SCHEMA_CLASS_SYSTEM_CONFIG: SchemaClass = SchemaClass {
...
pub static SCHEMA_CLASS_OAUTH2_RS_DL9: SchemaClass = SchemaClass {
...
pub static SCHEMA_CLASS_OAUTH2_RS_BASIC_DL5: SchemaClass = SchemaClass {
...
// Introduced in DomainLevel4
pub static SCHEMA_CLASS_OAUTH2_RS_PUBLIC_DL4: SchemaClass = SchemaClass {
    uuid: UUID_SCHEMA_CLASS_OAUTH2_RS_PUBLIC,
    name: EntryClass::OAuth2ResourceServerPublic.into(),
    description: "The class representing a configured Public OAuth2 Client with PKCE verification"
        .to_string(),
...
pub static SCHEMA_CLASS_OAUTH2_CLIENT: SchemaClass = SchemaClass {
...
pub static SCHEMA_CLASS_KEY_PROVIDER_DL6: SchemaClass = SchemaClass {
...
pub static SCHEMA_CLASS_KEY_PROVIDER_INTERNAL_DL6: SchemaClass = SchemaClass {
...
pub static SCHEMA_CLASS_KEY_OBJECT_DL6: SchemaClass = SchemaClass {
...
pub static SCHEMA_CLASS_KEY_OBJECT_JWT_ES256_DL6: SchemaClass = SchemaClass {
    uuid: UUID_SCHEMA_CLASS_KEY_OBJECT_JWT_ES256,
    name: EntryClass::KeyObjectJwtEs256.into(),
    description: "A marker class indicating that this keyobject must provide jwt es256 capability."
        .to_string(),
    systemsupplements: vec![EntryClass::KeyObject.into()],
    ..Default::default()
};

pub static SCHEMA_CLASS_KEY_OBJECT_JWT_HS256_DL6: SchemaClass = SchemaClass {
    uuid: UUID_SCHEMA_CLASS_KEY_OBJECT_JWT_HS256,
    name: EntryClass::KeyObjectJwtHs256.into(),
    description: "A marker class indicating that this keyobject must provide jwt hs256 capability."
        .to_string(),
    systemsupplements: vec![EntryClass::KeyObject.into()],
    ..Default::default()
};

pub static SCHEMA_CLASS_KEY_OBJECT_JWT_RS256: SchemaClass = SchemaClass {
    uuid: UUID_SCHEMA_CLASS_KEY_OBJECT_JWT_RS256,
    name: EntryClass::KeyObjectJwtRs256.into(),
    description: "A marker class indicating that this keyobject must provide jwt rs256 capability."
        .to_string(),
    systemsupplements: vec![EntryClass::KeyObject.into()],
    ..Default::default()
};

pub static SCHEMA_CLASS_KEY_OBJECT_JWE_A128GCM_DL6: SchemaClass = SchemaClass {
...
pub static SCHEMA_CLASS_KEY_OBJECT_HKDF_S256: SchemaClass = SchemaClass {
...
pub static SCHEMA_CLASS_KEY_OBJECT_INTERNAL_DL6: SchemaClass = SchemaClass {
...
pub static SCHEMA_CLASS_CLIENT_CERTIFICATE_DL7: SchemaClass = SchemaClass {
...
pub static SCHEMA_CLASS_APPLICATION: SchemaClass = SchemaClass {
...
pub static SCHEMA_CLASS_OUTBOUND_MESSAGE: SchemaClass = SchemaClass {
...
pub static SCHEMA_CLASS_FEATURE: SchemaClass = SchemaClass {
...
pub static SCHEMA_CLASS_MEMORIAL: SchemaClass = SchemaClass {
...
pub static SCHEMA_CLASS_ASSERTION_NONCE: SchemaClass = SchemaClass {

...
pub const UUID_IDM_TRUST_ADMINS: Uuid = uuid!("00000000-0000-0000-0000-000000000056");
...
pub const UUID_SCHEMA_ATTR_OAUTH2_TRUST_UNIQUE_USER_ID: Uuid =
...
pub const UUID_SCHEMA_ATTR_OAUTH2_TRUST_CREDENTIAL_UUID: Uuid =
...
pub const UUID_SCHEMA_CLASS_PERSON_OAUTH2_TRUST: Uuid =
    uuid!("00000000-0000-0000-0000-ffff00000209");
pub const UUID_SCHEMA_CLASS_OAUTH2_TRUST_CLIENT: Uuid =
    uuid!("00000000-0000-0000-0000-ffff00000210");
pub const UUID_SCHEMA_ATTR_OAUTH2_TRUST_PROVIDER: Uuid =
...
pub const UUID_IDM_ACP_TRUST_ADMIN: Uuid = uuid!("00000000-0000-0000-0000-ffffff000079");
pub const UUID_IDM_ACP_OAUTH2_TRUST_ENROL: Uuid = uuid!("00000000-0000-0000-0000-ffffff000080");

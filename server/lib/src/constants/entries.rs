...
impl TryFrom<String> for Attribute {
    ...
    fn try_from(val: String) -> Result<Self, OperationError> {
        let res = match val.as_str() {
            ...
            ATTR_KEY_INTERNAL_ES256 => Attribute::KeyInternalEs256,
            ATTR_KEY_INTERNAL_RS256 => Attribute::KeyInternalRs256,
            ATTR_KEY_INTERNAL_HS256 => Attribute::KeyInternalHs256,
...
impl From<Attribute> for &'static str {
    fn from(val: Attribute) -> Self {
        match val {
            ...
            Attribute::KeyInternalEs256 => ATTR_KEY_INTERNAL_ES256,
            Attribute::KeyInternalRs256 => ATTR_KEY_INTERNAL_RS256,
            Attribute::KeyInternalHs256 => ATTR_KEY_INTERNAL_HS256,

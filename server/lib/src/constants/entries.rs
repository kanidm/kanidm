...
impl TryFrom<String> for Attribute {
    ...
    fn try_from(val: String) -> Result<Self, OperationError> {
        let res = match val.as_str() {
            ...
            ATTR_KEY_INTERNAL_JWT_ES256 => Attribute::KeyInternalJwtEs256,
            ATTR_KEY_INTERNAL_JWT_RS256 => Attribute::KeyInternalJwtRs256,
            ATTR_KEY_INTERNAL_JWT_HS256 => Attribute::KeyInternalJwtHs256,
...
impl From<Attribute> for &'static str {
    fn from(val: Attribute) -> Self {
        match val {
            ...
            Attribute::KeyInternalJwtEs256 => ATTR_KEY_INTERNAL_JWT_ES256,
            Attribute::KeyInternalJwtRs256 => ATTR_KEY_INTERNAL_JWT_RS256,
            Attribute::KeyInternalJwtHs256 => ATTR_KEY_INTERNAL_JWT_HS256,

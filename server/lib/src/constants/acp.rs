...
lazy_static! {
    pub static ref E_IDM_ACP_ACCOUNT_MANAGE_PRIV_V1: EntryInitNew = entry_init!(
        ...
        ("acp_create_class", Value::new_iutf8(ValueClass::Object.into())),
        ("acp_create_class", Value::new_iutf8(ValueClass::Account.into())),
        ("acp_create_class", Value::new_iutf8(ValueClass::ServiceAccount.into()))
    );
}

...
struct ProfileView {
    ...
    profile_partial: EnrollDeviceView,
}

#[derive(Template, WebTemplate)]
#[template(path = "enroll_device.html")]
pub(crate) struct EnrollDeviceView {
...
pub(crate) async fn view_enroll_get(
    ...
    Ok(ProfileView {
        ...
        profile_partial: EnrollDeviceView {
            menu_active_item: ProfileMenuItems::EnrollDevice,
            qr_code_svg,
            secret,
            uri,
        },

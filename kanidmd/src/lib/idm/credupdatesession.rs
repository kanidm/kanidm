...
mod tests {
    ...
    fn test_idm_credential_update_session_init() {
        run_idm_test!(
            |_qs: &QueryServer, idms: &IdmServer, _idms_delayed: &mut IdmServerDelayed| {
                ...
                let e = entry_init!(
                    ...
                    (
                        "uuid",
                        Value::new_uuid(testperson_uuid)
                    ),
                ...
                let testperson = idms_prox_write.qs_write

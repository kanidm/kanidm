...
pub mod prelude {
    ...
    pub use crate::{
        admin_error, admin_info, admin_warn, filter_error, filter_info, filter_trace, perf_trace,
        request_error, request_info, request_trace, request_warn, security_access,

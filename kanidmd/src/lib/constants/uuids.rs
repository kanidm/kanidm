...
pub const STR_UUID_SCHEMA_ATTR_USERACCOUNTCONTROL: &str = "00000000-0000-0000-0000-ffff00000088";
...
lazy_static! {
    ...
    pub static ref UUID_SCHEMA_ATTR_USERACCOUNTCONTROL: Uuid =
        Uuid::parse_str(STR_UUID_SCHEMA_ATTR_USERACCOUNTCONTROL).unwrap();

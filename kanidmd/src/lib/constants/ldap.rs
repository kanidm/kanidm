...
///
/// The flags are cumulative. To disable a user's account, set the attribute to 514 (2 + 512).
///
...
impl LdapUac {
    ...
    /// Add an LdapUacFlag to a LdapUac object
...
/// Flag values for the LdapUac value.
...
mod tests {
    ...
    fn test_ldap_uac_adding_flags() {
        use crate::constants::ldap::{LdapUac, LdapUacFlag};

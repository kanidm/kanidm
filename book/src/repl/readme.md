...
different servers recieving a change. This may result in some users noticing discrepencies that are
quickly resolved.
...
the same server unless a failover event occurs. This will help to minimise discrepencies.
...
The act of suppling data to a remote server.
...
The node that is suppling data to another node.

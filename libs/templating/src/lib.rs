...
{
    pub fn render(&self, ctx: &C::Context) -> Result<Option<String>, O::Error> {
        // Make the buffer.
...
#[cfg(test)]
mod tests {
    use super::{template, Template, TemplateAttribute, TemplateCondition, TemplateRenderer};
    use serde::Serialize;
    use std::str::FromStr;
    ...
    fn single_operand() {
        ...
        assert_eq!(y.as_deref(), Some("direct ident"));
    }
    ...
    fn literal_operand() {
        ...
        assert_eq!(y.as_deref(), Some("some_literal direct ident"));
    }
    ...
    fn literal_operand_literal() {
        ...
        assert_eq!(
            y.as_deref(),
            Some("some_literal direct ident another_literal")
        );
    }
    ...
    fn operand_literal() {
        ...
        assert_eq!(y.as_deref(), Some("direct ident another_literal"));
    }
    ...
    fn literal_operand_literal_operand() {
        ...
        assert_eq!(
            y.as_deref(),
            Some("some_literal direct ident another_literal direct ident")
        );
    }
    ...
    fn operand_operand() {
        ...
        assert_eq!(y.as_deref(), Some("direct identdirect ident"));
    }

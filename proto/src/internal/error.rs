...
pub enum OperationError {
    ...
    SC0034Oauth2ClaimMapClaimNameInvalid,
    SC0035Oauth2ClaimMapClaimValueInvalid,
    SC0036Oauth2ClaimMapScopeNameInvalid,
    // Migration
...
impl OperationError {
    ...
    pub fn message(&self) -> Option<String> {
        match self {
            ...
            Self::SC0034Oauth2ClaimMapClaimNameInvalid => Some("SCIM Oauth2 Claim Map contained an invalid claim name".into()),
            Self::SC0035Oauth2ClaimMapClaimValueInvalid => Some("SCIM Oauth2 Claim Map contained an invalid claim value".into()),
            Self::SC0036Oauth2ClaimMapScopeNameInvalid => Some("SCIM Oauth2 Claim Map contained an invalid scope name".into()),

...
pub const ATTR_OAUTH2_INTROSPECTION_ENDPOINT: &str = "oauth2_introspection_endpoint";
...
pub const ATTR_OAUTH2_REVOCATION_ENDPOINT: &str = "oauth2_revocation_endpoint";
...
pub const ATTR_OAUTH2_TRUST_PROVIDER: &str = "oauth2_trust_provider";
pub const ATTR_OAUTH2_TRUST_UNIQUE_USER_ID: &str = "oauth2_trust_unique_user_id";
...
pub const ENTRYCLASS_OAUTH2_TRUST_CLIENT: &str = "oauth2_trust_client";
...
pub const ENTRYCLASS_PERSON_OAUTH2_TRUST: &str = "person_oauth2_trust";

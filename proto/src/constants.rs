...
pub const ATTR_KEY_INTERNAL_JWT_ES256: &str = "key_internal_jwt_es256";
pub const ATTR_KEY_INTERNAL_JWT_RS256: &str = "key_internal_jwt_rs256";
pub const ATTR_KEY_INTERNAL_JWT_HS256: &str = "key_internal_jwt_hs256";

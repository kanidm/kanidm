...
pub enum Attribute {
    ...
    DomainAllowCredentialResetEmail,
...
impl Attribute {
    pub fn as_str(&self) -> &str {
        match self {
            ...
            Attribute::DomainAllowCredentialResetEmail => ATTR_DOMAIN_ALLOW_CREDENTIAL_RESET_EMAIL,
    ...
    fn inner_from_str(value: &str) -> Self {
        ...
        match value.to_lowercase().as_str() {
            ...
            ATTR_DOMAIN_ALLOW_CREDENTIAL_RESET_EMAIL => Attribute::DomainAllowCredentialResetEmail,

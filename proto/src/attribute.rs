...
impl Attribute {
    pub fn as_str(&self) -> &str {
        match self {
            ...
            Attribute::OAuth2IntrospectionEndpoint => ATTR_OAUTH2_INTROSPECTION_ENDPOINT,
            ...
            Attribute::OAuth2RevocationEndpoint => ATTR_OAUTH2_REVOCATION_ENDPOINT,
            ...
            Attribute::OAuth2TrustProvider => ATTR_OAUTH2_TRUST_PROVIDER,
            Attribute::OAuth2TrustUniqueUserId => ATTR_OAUTH2_TRUST_UNIQUE_USER_ID,
    ...
    fn inner_from_str(value: &str) -> Self {
        ...
        match value.to_lowercase().as_str() {
            ...
            ATTR_OAUTH2_INTROSPECTION_ENDPOINT => Attribute::OAuth2IntrospectionEndpoint,
            ...
            ATTR_OAUTH2_REVOCATION_ENDPOINT => Attribute::OAuth2RevocationEndpoint,
            ...
            ATTR_OAUTH2_TRUST_PROVIDER => Attribute::OAuth2TrustProvider,
            ATTR_OAUTH2_TRUST_UNIQUE_USER_ID => Attribute::OAuth2TrustUniqueUserId,

...
impl Attribute {
    pub fn as_str(&self) -> &str {
        match self {
            ...
            Attribute::OAuth2TrustCredentialUuid => ATTR_OAUTH2_TRUST_CREDENTIAL_UUID,
    ...
    fn inner_from_str(value: &str) -> Self {
        ...
        match value.to_lowercase().as_str() {
            ...
            ATTR_OAUTH2_TRUST_CREDENTIAL_UUID => Attribute::OAuth2TrustCredentialUuid,

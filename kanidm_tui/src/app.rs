...
pub fn render(&mut self){
    self.display.render(self.active_menu_item,self.input_mode,self.username.clone(),self.masked_password.clone(),self.login_list_no);
}
}

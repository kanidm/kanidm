...
Set up your dev environment using `uv` - `python -m pip install uv && uv sync && uv venv`.
...
| 1.2.1   | 2025-12-22 | Minor typing tweaks, updating dependencies, bump minimum python to 3.10        |
